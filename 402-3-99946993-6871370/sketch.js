...
Officer: 6871370
CaseNum: 402-3-99946993-6871370
...
function draw()
{
	...
	else if(det.locationX<260 && det.locationY<197){
		det.speedX = 1;
		det.speedY = 0;
	}
	else if(det.locationX>260 && det.locationY<505 && det.locationX < 510){
		det.speedX = 0;
		det.speedY = 1;
	}
	else if(det.locationX<510 && det.locationY>505){
		det.speedX = 1;
		det.speedY = 0;
	}
	else if(det.locationX>510 && det.locationY>130 && det.locationX<635){
		det.speedX = 0;
		det.speedY = -1;
	}
	else if(det.locationX<635 && det.locationY<130){
		det.speedX = 1;
		det.speedY = 0;
	}
	else if(det.locationX>635 && det.locationY<574 && det.locationX<762){
		det.speedX = 0;
		det.speedY = 1;
	}
	else if(det.locationX<762 && det.locationY>574){
		det.speedX = 1;
		det.speedY = 0;
	}
	else if(det.locationX>762 && det.locationY>70 && det.locationX<890){
		det.speedX = 0;
		det.speedY = -1;
	}
	else if(det.locationX<890 && det.locationY<70){
		det.speedX = 1;
		det.speedY = 0;
	}
	else if(det.locationX>890 && det.locationY<700){
		det.speedX = 0;
		det.speedY = 1;
	}
