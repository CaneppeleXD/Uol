...
Officer: 6871370
CaseNum: 303-0-37487436-6871370
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make SecretVaultValueA equal to 47

	When the mouse button is pressed:
	- Make SecretVaultValueA equal to 23

	When any key is released:
	- Make SecretVaultValueA equal to 16

	When the mouse button is released:
	- Make SecretVaultValueA equal to 10

	When the mouse button is pressed:
	- Make SecretVaultValueB equal to 84

	Whilst the mouse is being dragged:
	- Make SecretVaultValueB equal to 22

	When the mouse button is released:
	- Make SecretVaultValueB equal to 0

	Whilst the mouse is moving:
	- Make SecretVaultValueB equal to 67
...
var SecretVaultValueA;
var SecretVaultValueB;
...
function mouseMoved()
{
	SecretVaultValueB=67;
	console.log("mouseMoved", mouseX, mouseY);
}

function mouseDragged()
{
	SecretVaultValueB=22;
	SecretVaultValueA=47;
	console.log("mouseDragged", mouseX, mouseY);
}

function mousePressed()
{
	SecretVaultValueB=84;
	SecretVaultValueA=23;
...
function draw()
{
	...
	drawDial(200, SecretVaultValueA, 51);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(SecretVaultValueB);
	pop();
