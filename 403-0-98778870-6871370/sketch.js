...
Officer: 6871370
CaseNum: 403-0-98778870-6871370
...
- To sound the alarm, draw a Magenta rectangle covering the remainder of the map from Huffman Street to the east.
...
function draw()
{
    ...
    if(mouseX>1030){
      fill(255, 0, 255);
      stroke(255, 0, 255);
      rect(1030,0,img.width-1030,img.height)
    }
